...
namespace VampKnives.UI
{
    ...
    class WarningMessage : UIState
    {
        //public static bool visible = false;
        // Update is called on a UIState while it is the active state of the UserInterface.
        // We use Update to handle automatically closing our UI when the player is no longer talking to our NPC.
        ...
        //    if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != VampKnives.instance.NPCType("VampireNPC"))
        //    {
        ...
        //        VampKnives.instance.WarningMessagePerson.SetState(null);
        //    }
        //}
        ...
        //    MainPanel.Left.Set(Main.screenWidth - (Main.screenWidth / 2), 0f);
        //    MainPanel.Top.Set(Main.screenHeight + (Main.screenHeight / 2), 0f);
        //    MainPanel.Width.Set(100, 0f);
        //    MainPanel.Height.Set(100, 0f);
        //    MainPanel.BackgroundColor = new Color(255, 255, 255);
        ...
        //    MainPanel.Append(barBackground);

        //    UITextBox Yes = new UITextBox("Yes", 5);
        //    Yes.Left.Set(0, 0f);
        //    Yes.Top.Set(0, 0f);
        //    Yes.Height.Set(50, 0f);
        //    Yes.Width.Set(50, 0f);
        //    MainPanel.Append(Yes);
        ...
        //    float leftSet = Main.screenWidth - (Main.screenWidth / 2);
        //        float topSet = Main.screenHeight + (Main.screenHeight / 2);
        //    string message = "TEST";
        //    ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, Main.fontMouseText, message, new Vector2(leftSet, topSet), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, Vector2.Zero, Vector2.One, -1f, 2f);
        //}
        //protected override void DrawSelf(SpriteBatch spriteBatch)
        //{
        //    base.DrawSelf(spriteBatch);
        ...
        //                ItemText.Newlse;
        //        }Text(vanillaItemSlot.item, vanillaItemSlot.item.stack, true, false);
