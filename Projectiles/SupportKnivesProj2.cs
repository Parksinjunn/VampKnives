...
{
    public class SupportKnivesProj2 : KnifeProjectile
    {
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("SupportProj"), (int)(projectile.damage * 1.75), 0, owner.whoAmI);
            Hoods(n);
        }
