...
namespace VampKnives.Projectiles.Imbued.Ichor
{
	public class IchorManaLKnifeProj : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.Name = "LuminiteMIchor Knife";
			projectile.width = 16;
		...
		public override void AI()
		{
           ...
           int DustID2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width-3, projectile.height-3, 244, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 10, Color.Gold, 1.8f);
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(69, 300); //LuminiteIchor! debuff for 5 seconds
