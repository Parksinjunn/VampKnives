...
namespace VampKnives.Projectiles.Imbued.Gold
{
	public class GoldLKnifeProj : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.Name = "LuminiteGold Knife";
			projectile.width = 16;
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(72, 300); //LuminiteGold! debuff for 5 seconds
