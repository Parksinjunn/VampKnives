...
namespace VampKnives.Projectiles.Imbued.Fire
{
	public class FireLKnifeProj : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.Name = "LuminiteFire Knife";
			projectile.width = 16;
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(24, 300); //LuminiteFire! debuff for 5 seconds
