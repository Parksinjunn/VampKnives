...
namespace VampKnives.Projectiles.Imbued.Poison
{
	public class PoisonMLKnifeProj : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.Name = "LuminitePoisonM Knife";
			projectile.width = 16;
		...
		public override void AI()
		{
           ...
           int DustID2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width-3, projectile.height-3, 244, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 10, Color.MediumTurquoise, 1.8f);
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(20, 300); //LuminitePoisonM! debuff for 5 seconds
