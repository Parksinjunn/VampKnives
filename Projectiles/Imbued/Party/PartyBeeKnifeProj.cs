...
{
	public class PartyBeeKnifeProj : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.Name = "Party Bee Knife";
			projectile.width = 16;
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            int DustID3 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width - 3, projectile.height - 3, 254, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 10, Color.Pink, 1.8f);
