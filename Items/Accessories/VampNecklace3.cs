...
{
    public class VampNecklace3 : KnifeItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            TooltipLine line = new TooltipLine(mod, "Face", "Tier 3");
            line.overrideColor = new Color(255, 0, 0);
            tooltips.Add(line);
            TooltipLine line3 = new TooltipLine(mod, "Face", "Kills: " + (p.NeckProgress));
        ...
        {
            player.GetModPlayer<ExamplePlayer>().VampMax = 4000 + player.GetModPlayer<ExamplePlayer>().NeckAdd;
