...
namespace VampKnives.Items.Armor
{
    ...
    public class PsionicChestplate : KnifeItem
    {
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            {
                p.DelayAdd = 30;
                d.knifeDamageMult = 1.06f;
                item.value = Item.sellPrice(0, 3, 0, 0);
            }
            if (NPC.downedBoss3)
            {
                p.DelayAdd = 30;
                d.knifeDamageMult = 1.08f;
