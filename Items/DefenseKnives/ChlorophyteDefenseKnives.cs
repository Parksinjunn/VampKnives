...
{
    public class ChlorophyteDefenseKnives : KnifeDefenseItem
    {
        public override void SetStaticDefaults()
        {
                DisplayName.SetDefault("Chlorophyte Defense Knives");
                Tooltip.SetDefault("These knives form a protective Chlorophyte wall when thrown");
            PlateType = ModContent.GetInstance<Items.Materials.Plates.ChlorophytePlate>();
        }
        ...
        public override void SafeSetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("ChlorophyteDefenseKnivesProj");
            item.shootSpeed = 7f;
        }
    }
}
