...
{
    public class DaedalusStormblades : KnifeDamageItem
    {
        ...
        {
            item.damage = 34; //PUT DAMAGE, GENERALLY 1/2 OF COMPONENT'S DAMAGE       
            item.width = 44;
            item.height = 44;
            item.useTime = 22;
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("DaedalusStormbladesProj");
            item.shootSpeed = 15f;
        }
